...
<div class="min-h-screen overflow-y-hidden bg-neutral">
	...
	<div class="relative px-6 pt-24 isolate lg:px-8">
		<div
		...
		<div class="max-w-2xl py-32 mx-auto sm:py-48 lg:py-56">
			<div class="text-center">
				<h1 class="font-bold tracking-tight text-8xl text-primary sm:text-8xl">Build Together</h1>
				<p class="mt-6 text-4xl leading-8 text-secondary">Where construction meets connection.</p>
			</div>
		</div>
		<div
